...
export const setPublicDesigns = createAction<IDesign[]>(
	"designs/setPublicDesigns"
)
export const unsetDesign = createAction<{ id: string }>("designs/unsetDesign")

export const getPublicDesigns = createAsyncThunk<
	void,
	never,
	{ rejectValue: Record<string, string[]> }
>("designs/getPublicDesigns", async (_, { rejectWithValue, dispatch }) => {
	try {
